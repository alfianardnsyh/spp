...
<body>
<h3>SEKOLAH MENENGAH KEJURUAN <br/>LAPORAN TUNGGAKAN SPP</h3>
<hr/>
<table  width="100%" border="1" cellspacing="0" cellpadding="4">
	...
	<?php
	$sqlTagihan = mysqli_query($konek, "SELECT spp.*,siswa.nis, siswa.namasiswa, siswa.kelas FROM spp INNER JOIN siswa ON spp.idsiswa=siswa.idsiswa WHERE spp.ket is NULL ORDER BY siswa.namasiswa ASC");
	$no=1;
	$total = 0;
